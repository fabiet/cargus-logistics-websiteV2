...
import { Truck, Ship, Package2, ArrowRight, Globe, CheckCircle, Plane, Star, Users, Shield, Clock, Menu, X, Languages } from 'lucide-react';
        ...
        <div className={`md:hidden transition-all duration-300 ease-in-out ${
          ...
          <div className="px-6 py-4 bg-slate-950/95 backdrop-blur-md border-t border-slate-800/50">
            <div className="flex flex-col space-y-4">
              ...
              <a 
                href="#services" 
                className="text-slate-300 hover:text-white transition-colors py-2 border-b border-slate-800/50"
